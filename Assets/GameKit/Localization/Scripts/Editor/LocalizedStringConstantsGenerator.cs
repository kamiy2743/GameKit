...
namespace GameKit.Localization.Editor
{
    ...
    public static class LocalizedStringConstantsGenerator
    {
        ...
        static void GenerateConstantsAsset()
        {
            ...
            var declarations = new List<TableDeclaration>();
            ...
            if (collections != null)
            {
                foreach (var collection in collections)
                {
                    ...
                    declarations.Add(new TableDeclaration(className, collection.TableCollectionName, entryDeclarations));
                }
            }

            declarations.Sort((a, b) => string.CompareOrdinal(a.TableName, b.TableName));

            WriteConstantsFile(declarations, namespaceName, outputPath);
        ...
        static void WriteConstantsFile(IReadOnlyList<TableDeclaration> declarations, string namespaceName, string assetPath)
        {
            SourceBuilder.Clear();
